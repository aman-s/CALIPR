...
% This operator is only used for FAE calculation and not for the smoothing
% of T2 distributions

function  Dstr = getSpatialDerivOperator3D_wt_MaskingGeneral(Filter, Sz, Mask_ROI, Resol)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    elseif strcmp(FilterDim, '3D')
        ...
        display('High pass filter type not defined')
        stop
    end
    ...
    for ind = 1:mm*nn*pp
        ...
        elseif strcmp(FilterDim, '3D')
            ...
            %d1 = Convert_3D_to_1D_SpatialOnly(D1);
            %%d1 = ConvertArr_3Dt_to_1D(D1);   % no temporal domain; but thee function will still work
            d1 =ConvertArr_3D_to_1D_SpatialOnly(D1);
        else
            display('High pass filter not defined')
            exit
        end 
