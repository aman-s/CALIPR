...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% mex compile with optimizations enabled
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    COPTIMFLAGS = '''-O2 -march=native -DNDEBUG''';
    LDOPTIMFLAGS = '''-O2''';

    FILES = ['lbfgsb_wrapper.c ', strjoin(SRC)];

    fprintf('Compiling lbfgsb.c\n');
    eval([ ...
        'mex ', ...
    ...
    clear FILES COPTIMFLAGS LDOPTIMFLAGS
