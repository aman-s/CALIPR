function CALIPR_Philips_Brain_FullProcess(fulldat_names)
	%%%%%%% 
	...
	% TMP
	% addpath('/Users/adamdvorak/Titan_Remote_Mount/Research/MWI_Development/CALIPR/CALIPR_Publication_Share/CALIPR_Code/')
	...
	% addpath(fullfile('/home/bizon/bart-master', 'matlab'));
	% setenv('TOOLBOX_PATH', '/home/bizon/bart-master');
	...
	mreconpath = '/home/bizon/mrecon';
	addpath(genpath(fullfile(mreconpath)))
	% MRecon.Activate('<ACTIVATION TOKEN>') % run in matlab with admin privileges, to license all users
	...
	addpath(genpath('/home/bizon/Research/MWI_Development/CALIPR/CALIPR_Publication_Share/CALIPR_Code/DK_MWI_Analysis/'))
	...
	%                     USdat = Eall;
	                    ...
	                    if save_cs_nii == 1
	                        ...
	                        !antsBrainExtraction.sh -d 3 -k 0 -z 0 -a CS_E1.nii.gz -e ~/Research/Templates/OASIS/T_template0.nii.gz -m ~/Research/Templates/OASIS/T_template0_BrainCerebellumProbabilityMask.nii.gz -f ~/Research/Templates/OASIS/T_template0_BrainCerebellumRegistrationMask.nii.gz -o CS_E1 &>/dev/null
	                        !gunzip CS.nii.gz
	...
	%                                     batch_id
	            ...
	            %                         size(tmp)
	                                ...
	                                if save_calipr_nii == 1
	                                    ...
	                                    !antsBrainExtraction.sh -d 3 -k 0 -z 0 -a CALIPR_E1.nii.gz -e ~/Research/Templates/OASIS/T_template0.nii.gz -m ~/Research/Templates/OASIS/T_template0_BrainCerebellumProbabilityMask.nii.gz -f ~/Research/Templates/OASIS/T_template0_BrainCerebellumRegistrationMask.nii.gz -o CALIPR_E1 &>/dev/null
